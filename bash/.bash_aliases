...
alias gnome-terminal='dbus-launch --exit-with-session gnome-terminal'
...
alias fzk="ps auwwx | fzf --height=25% | awk '{print \$2}' | xargs -r kill"
alias fzsk="ps auwwx | fzf --height=25% | awk '{print \$2}' | xargs -r sudo kill"
